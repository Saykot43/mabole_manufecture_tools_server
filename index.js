...
async function run() {
    try {
        ...
        const productsCollection = client.db('mobile-manufacture').collection('products');
        const ordersCollection = client.db('mobile-manufacture').collection('orders');
        const usersCollection = client.db('mobile-manufacture').collection('users');
        const reviewsCollection = client.db('mobile-manufacture').collection('reviews');
        const paymentCollection = client.db('mobile-manufacture').collection('payments');
